...
export const infinitiveGerundContentMap: Record<string, string> = {
...
export const infinitiveGerundBackKeyboard = new InlineKeyboard().text(
  "Ortga",
  "grammar_view:infinitive-gerund",
);
