...
import { SoloQuizService, type SoloUserContext } from "../soloQuiz/SoloQuizService.js";
import { soloQuizManager } from "../soloQuiz/SoloQuizManager.js";
import type { SoloAnswerResult } from "../soloQuiz/types.js";
import { safeAnswerCallback } from "../utils/callback.js";

let soloService: SoloQuizService | null = null;

function userCtx(ctx: Context): SoloUserContext | null {
...
function feedbackForResult(result: SoloAnswerResult): string | undefined {
  switch (result.kind) {
    case "correct":
      return "✅ To'g'ri!";
    case "wrong":
...
async function showGameMenu(ctx: Context, edit = false): Promise<void> {
...
export function registerGameHandlers(composer: Composer<Context>, api: Api): void {
...
export function shutdownGameSystem(): void {
