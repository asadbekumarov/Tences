...
import {
  conditionalsBackKeyboard,
  conditionalsContentMap,
  conditionalsIntro,
  conditionalsMenuKeyboard,
} from "../grammar/conditionals.js";
import {
  infinitiveGerundBackKeyboard,
  infinitiveGerundContentMap,
  infinitiveGerundIntro,
  infinitiveGerundMenuKeyboard,
} from "../grammar/infinitiveGerund.js";
import { safeAnswerCallback } from "../utils/callback.js";

export function registerGrammarHandlers(bot: Composer<Context>) {
